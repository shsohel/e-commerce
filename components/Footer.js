...
export const Footer = () => {
    return (
        <div className="bg-[#24243C] bg-no-repeat bg-cover text-white mx-auto  px-6 ">
                        ...
                        <div className="mt-14">
                            ...
                            <div className="flex items-center justify-between">
                                <p className=" flex-2 text-sm ">
                                    Read about the latest in workplace trends,
                                    events and insights straight to your inbox.
                                </p>
                                <div className="ml-2 flex-1">
                                    <div className="flex justify-between">
                                        ...
                                        <FaLinkedin
                                            size={20}
                                            className="ml-1 my-1 mr-0 flex-1"
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className=" text-neutral-400 font-semibold text-[0.8rem] mt-3">
                                <input
                                    type="checkbox"
                                    className=" bg-sky-800 mr-1 "
                                />
                                <span>
                                    Yes. I'd like to receive marketing emails
                                    from Edge and agree to it's 
                    ...
                    <div className="col-span-1">
                                    ...
                                    {nav.subItem.map((subNav, index) => (
                                        ...
                                        >
                                            <Link href={subNav.link}>
                                                <a className="text-[0.9rem] font-semibold py-1">
                                                    {subNav.name}
                                                </a>
                                            </Link>
                                        </div>
                        ...
                        <div className="mt-20 ">
                            ...
                            <div className="uppercase text-neutral-400 font-semibold text-[.6rem] mt-3">
                                <p>
                                    Edge refers to the global platform and may
                                    refer to one or more licensed companies.
                                    Each of which is a separate legal entity .
                                </p>
                                <p>
                                    Edge Brand and technology Owned by G.C.C
                                    Limited, Comapany No. 10453456
                                </p>
                                <p className="mt-2">
                                    G.C.C Limited @ All Rights Reserved 2022
                                </p>
                            </div>
                        </div>
                    </div>
